...
<head>
    ...
    <title>Listar tipos usuários</title>
</head>
<?php
                ...
                <?php foreach ($tiposUsuario as $tipoUsuario) :?>
                    <tr>
                        ...
                        <form action="../routers/tipoUsuarioRouter.php" method="post">
                            <input type="hidden" name="idTipoUsuario" id="idTipoUsuario" id="idTipoUsuario" value="<?= $tipoUsuario->idTipoUsuario; ?>">
